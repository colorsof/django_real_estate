...
class UpvotePostSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):  #validated_data
...
class DownvotePostSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):  
        ...
        if user in instance.upvoted_by.all():
            ...
            instance.upvotes = F("upvotes") - 1  #f condition
        ...
        instance.save()
        instance.refresh_from_db() #why and when
        return instance
...
class BasePostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "slug",
            "author_username",
            "is_bookmarked", #whats the point here
            "created_at",
            "updated_at",
            "view_count",
            "upvotes",
            "downvotes",
            "is_upvoted", #point of this?
            "replies_count",
            "avatar",
        ]
        read_only_fields = [
    ...
    def get_updated_at(self, obj):
            then = obj.updated_at  #is then a variable like now above?
